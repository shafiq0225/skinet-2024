...
import { OrderDetailedComponent } from './features/orders/order/order-detailed/order-detailed.component';
...
export const routes: Routes = [
    ...
    { path: '**', redirectTo: 'not-found', pathMatch: 'full' } // Redirect any unknown paths to home,
];
